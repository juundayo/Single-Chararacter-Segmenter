...
modified_config_file = r"C:\Users\bgat\TranscriptMapping\checkpoints\mask_rcnn_r50_fpn_1x_coco_modified.py"
cfg.dump(modified_config_file)

# Paths!
checkpoint_file = r"C:\Users\bgat\TranscriptMapping\src\work_dirs\character_segmentation\latest.pth"
...
img = r"C:\Users\bgat\TranscriptMapping\Dataset\WordImages\027_3_L_02_W_01.tif"
result = inference_detector(model, img)

# Result print.
model.show_result(img, result, out_file="segmentation_output3.png")
